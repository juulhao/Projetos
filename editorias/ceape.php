			...
			<div class="content-page">
				<div class="row">
					<div class="col-md-6">
						...
						<?php
							$args = array( 'posts_per_page' => 8, 'category_name' => 'ceape-home' );
					...
					<div class="col-md-6 col-sm-12 testimonials-v1">
						<h2>Histórias e Depoimentos</h2>
						<?php
							$args = array( 'posts_per_page' => 3, 'category' => 10, 'orderby' => 'rand' );
				...
				<div class="row">
					<div class="col-md-12 col-sm-12">
						<h2>Onde Estamos</h2>
						<div class="maps"><?php echo do_shortcode('[put_wpgm id=2]'); ?></div>
					</div>
				</div>
				<hr class="blog-post-sep" />
				<div class="row">
					<div class="col-md-6 col-sm-1">
						<h2>Outras Notícias do <strong><?php echo $term->name; ?></strong></h2>
					</div>
					<div class="col-md-6 col-sm-1">
				...
				<?php
					...
					// Lista os últimos posts em 'Outras Notícias do CEAPE'
					query_posts( $query_string . '&post_type=post&posts_per_page=4&category_name=home-ultimas-ceape' );
					while ( have_posts() ) : the_post();
						get_template_part( 'content', get_post_format() );
					endwhile;
					wp_reset_query();
